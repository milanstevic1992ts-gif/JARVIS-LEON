...
export const PYTHON_TCP_SERVER_WAKE_WORD_MODEL_FILE_NAME =
  PYTHON_TCP_SERVER_SETTINGS.wake_word.model_file_name
export const PYTHON_TCP_SERVER_WAKE_WORD_MODEL_DIR_PATH = path.join(
  AUDIO_MODELS_PATH,
  'wake_word'
)
export const PYTHON_TCP_SERVER_WAKE_WORD_MODEL_PATH = path.join(
  PYTHON_TCP_SERVER_WAKE_WORD_MODEL_DIR_PATH,
  PYTHON_TCP_SERVER_WAKE_WORD_MODEL_FILE_NAME
)

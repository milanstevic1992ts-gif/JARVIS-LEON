...
// The default total includes the finishing pass, rather than adding it on top.
export const AGENT_MAX_ITERATIONS = 256
...
export const AGENT_COMPUTER_USE_REPEATED_VISUAL_STATE_THRESHOLD = 2
export const AGENT_COMPUTER_USE_POINT_PROXIMITY_PX = 48
